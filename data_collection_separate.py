 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "d68d0bea-9236-4cae-a56a-f7e2f5a5a5c5",
   "metadata": {},
   "outputs": [
    {
     "name": "stdin",
    ...
    },
    {
     ...
     "text": [
      ...
      "Started collecting data for 'happy' (face)\n",
      " Collected 200 frames for 'happy' (face)\n",
      "Saved 200 frames to dataset/face\\happy.csv\n",
      "\n",
      "Prepare to collect 'sad' data for face. Press 'c' to start collecting 200 frames.\n",
      "Press 'q' to quit anytime.\n",
      "Started collecting data for 'sad' (face)\n",
      " Collected 200 frames for 'sad' (face)\n",
      "Saved 200 frames to dataset/face\\sad.csv\n",
      "\n",
      "Prepare to collect 'angry' data for face. Press 'c' to start collecting 200 frames.\n",
      "Press 'q' to quit anytime.\n",
      "Started collecting data for 'angry' (face)\n",
      " Collected 200 frames for 'angry' (face)\n",
      "Saved 200 frames to dataset/face\\angry.csv\n",
      "\n",
      "Prepare to collect 'thumbs_up' data for hand. Press 'c' to start collecting 200 frames.\n",
      "Press 'q' to quit anytime.\n",
      "Started collecting data for 'thumbs_up' (hand)\n",
      " Collected 200 frames for 'thumbs_up' (hand)\n",
      "Saved 200 frames to dataset/hand\\thumbs_up.csv\n",
      "\n",
      "Prepare to collect 'peace' data for hand. Press 'c' to start collecting 200 frames.\n",
      "Press 'q' to quit anytime.\n",
      "Started collecting data for 'peace' (hand)\n",
      " Collected 200 frames for 'peace' (hand)\n",
      "Saved 200 frames to dataset/hand\\peace.csv\n",
      "\n",
      "Prepare to collect 'pointing' data for hand. Press 'c' to start collecting 200 frames.\n",
      "Press 'q' to quit anytime.\n",
      "Started collecting data for 'pointing' (hand)\n",
      " Collected 200 frames for 'pointing' (hand)\n",
      "Saved 200 frames to dataset/hand\\pointing.csv\n",
      "\n",
      "Prepare to collect 'open_hand' data for hand. Press 'c' to start collecting 200 frames.\n",
      "Press 'q' to quit anytime.\n",
      "Started collecting data for 'open_hand' (hand)\n",
      " Collected 200 frames for 'open_hand' (hand)\n",
      "Saved 200 frames to dataset/hand\\open_hand.csv\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "id": "a2e5401d-cdd0-4699-bb89-0b4e16b4f6c4",
   "metadata": {},
   "outputs": [],
   "source": []
  }
